Entrega 2 - Backend con WebSockets
...
Vista en tiempo real utilizando WebSockets.

Agregar productos desde la interfaz.

Eliminar productos desde la interfaz.

Actualización automática de la lista de productos para todos los clientes conectados.
